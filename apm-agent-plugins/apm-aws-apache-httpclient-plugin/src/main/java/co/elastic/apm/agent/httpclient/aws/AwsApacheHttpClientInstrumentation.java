 ...
 * #L%
 */
package co.elastic.apm.agent.httpclient.aws;
...
public class AwsApacheHttpClientInstrumentation extends ElasticApmInstrumentation {
    ...
    public ElementMatcher<? super TypeDescription> getTypeMatcher() {
        return hasSuperType(named("com.amazonaws.thirdparty.apache.http.impl.execchain.ClientExecChain"));
    }
    ...
    public ElementMatcher<? super MethodDescription> getMethodMatcher() {
        return named("execute")
            ...
            .and(returns(hasSuperType(named("com.amazonaws.thirdparty.apache.http.client.methods.CloseableHttpResponse"))))
            .and(takesArgument(0, hasSuperType(named("com.amazonaws.thirdparty.apache.http.conn.routing.HttpRoute"))))
            .and(takesArgument(1, hasSuperType(named("com.amazonaws.thirdparty.apache.http.client.methods.HttpRequestWrapper"))))
            .and(takesArgument(2, hasSuperType(named("com.amazonaws.thirdparty.apache.http.client.protocol.HttpClientContext"))))
            .and(takesArgument(3, hasSuperType(named("com.amazonaws.thirdparty.apache.http.client.methods.HttpExecutionAware"))));
    }

    @Override
    public Collection<String> getInstrumentationGroupNames() {
        return Arrays.asList("http-client", "aws-apache-httpclient");
    }
}
